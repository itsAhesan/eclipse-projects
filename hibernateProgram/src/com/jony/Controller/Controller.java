...
public class Controller {
	...
	public static void main(String[] args) {
		...
		if(login.equals("login")){
			...
			Query query = session.createQuery("from UserDto where username=:user and password =:password").setParameter("user", nam).setParameter("password", pas);
			UserDto dto1 = (UserDto) query.uniqueResult();
			
			if(dto1 != null){
				System.out.println("Login Successful, Below is the user Details");
				System.out.println(dto1.getId()+" "+dto1.getFullName()+" "+dto1.getPassword()+" "+dto1.getAddress());
